...
sales_agg = (
    ...
    .agg(
        ...
        매출건수_10대=("연령대_10_매출_건수", "sum"),
        매출건수_20대=("연령대_20_매출_건수", "sum"),
        매출건수_30대=("연령대_30_매출_건수", "sum"),
        매출건수_40대=("연령대_40_매출_건수", "sum"),
        매출건수_50대=("연령대_50_매출_건수", "sum"),
        매출건수_60대이상=("연령대_60_이상_매출_건수", "sum"),
        남성매출합=("남성_매출_금액", "sum"),
        여성매출합=("여성_매출_금액", "sum"),
        주중매출합=("주중_매출_금액", "sum"),
        주말매출합=("주말_매출_금액", "sum"),
        월요일매출합=("월요일_매출_금액", "sum"),
        화요일매출합=("화요일_매출_금액", "sum"),
        수요일매출합=("수요일_매출_금액", "sum"),
        목요일매출합=("목요일_매출_금액", "sum"),
        금요일매출합=("금요일_매출_금액", "sum"),
        토요일매출합=("토요일_매출_금액", "sum"),
        일요일매출합=("일요일_매출_금액", "sum"),
...
pop_agg = (
    ...
    .agg(
        ...
        월요일유동=("월요일_유동인구_수", "sum"),
        화요일유동=("화요일_유동인구_수", "sum"),
        수요일유동=("수요일_유동인구_수", "sum"),
        목요일유동=("목요일_유동인구_수", "sum"),
        금요일유동=("금요일_유동인구_수", "sum"),
        토요일유동=("토요일_유동인구_수", "sum"),
        일요일유동=("일요일_유동인구_수", "sum"),
    )
    .reset_index()
)
