...
urlpatterns = [
    ...
    path('api/trend/time-breakdown/', trend_time_breakdown),
    path('api/trend/gender-breakdown/', trend_gender_breakdown),
    ...
    path('api/recommend/similar/', recommend_similar),
]
